								...
								<table class="shop-checkout_products">
									<tbody>
										...
										<tr class="shop-checkout_products_item">
											<td>
												<a class="shop-checkout_products_item_name" href="shop-single-1.html">{{$cart->Name}}</a>
											</td>
									...
									<tfoot>
										<tr>
											<td>Total</td>
											<td class="text-right text-secondary">{{ $carts->where('Clientid', session('Clientid'))->sum(function($cart) { return $cart->Price * $cart->Quantity; }) }}</td>
										</tr>
									</tfoot>
								</table>
