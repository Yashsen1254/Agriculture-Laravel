							...
							<div class="grid">
								<div class="grid_row is-30 is-md-40">
									...
									<div class="grid_col is-12 is-sm-6">
										...
										<input class="form_control_input" type="text" name="firstname" placeholder="Enter your first name ..." required>
									</div>
									<div class="grid_col is-12 is-sm-6">
										<label class="form_label">Last name <span class="form_label_require">*</span></label>
										<input class="form_control_input" type="text" name="lastname" placeholder="Enter your last name ..." required>
									</div>
									<div class="grid_col is-12">
									...
									<div class="grid_col is-12 is-sm-6">
										<label class="form_label">Confirm Password <span class="form_label_require">*</span></label>
										<input class="form_control_input" type="password" name="password-confirm" placeholder="Enter your password ..." required>
									</div>
									<div class="grid_col is-12">
										<div class="grid">
											<div class="grid_row">
												<div class="grid_col is-12">
													<label class="form_check"><input class="form_control_checkbox" type="checkbox" name="agree" checked>I agree to the <a href="#" class="text-secondary">Terms and Conditions</a> and <a href="#" class="text-secondary">Privacy Policy.</a></label>
												</div>
											</div>
										</div>
									</div>
